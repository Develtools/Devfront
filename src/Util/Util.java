...
public class Util {
	...
	private static String jarFileAbsolutePath_latch = null;
	...
	public static String getJarFileAbsolutePath() {
		...
		if(jarFileAbsolutePath_latch != null)
			return jarFileAbsolutePath_latch;
	    ...
	    jarFileAbsolutePath_latch = path.substring(path.indexOf(':') + 1, path.lastIndexOf('!'));
	    return jarFileAbsolutePath_latch;
	}
